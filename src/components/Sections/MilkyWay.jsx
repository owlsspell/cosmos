...
export default function MilkyWay() {
    ...
    useGSAP(() => {
        ...
        gsap.from(".mainTitle", { opacity: 0, translateY: -150, duration: 0.8, delay: 1.5 });

        gsap.timeline()
            .from(".subTitle", { opacity: 0, translateY: -150, duration: 1.2, delay: 1.5 })
    ...
    return (
        <div className='relative min-h-screen w-auto overflow-hidden' ref={container}>
            ...
            <div className='flex items-center flex-col pt-20 mx-32 gap-4 z-10 relative h-screen text-white'>
            ...
            <img className='absolute left-1/2 bottom-0 h-24 scrollBtn opacity-0' src={scroll} alt="" />
        </div>
    )
}
